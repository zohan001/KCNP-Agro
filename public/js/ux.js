...
(function () {
    ...
    var I18N = {
        en: {
            ...
            p_activate: 'Activate Your <span class="gradient-text">Account</span>',
            p_activate_sub: 'Verify your email to start using KCNP Agro.',
            ...
            pr_eyebrow: 'Farmer Membership',
            pr_title: 'Simple, Affordable Plans',
            pr_sub: 'Sell your produce directly to traders. Prices are in Kenyan Shillings and paid by M-Pesa — the cost of a single chicken per month.',
            pr_per_month: 'month',
            pr_months: 'months',
            pr_plan_starter_desc: 'Post your produce and reach traders for 1 month.',
            pr_plan_grower_desc: 'The popular one-time set-up plan — 6 months of unlimited listings.',
            pr_plan_pro_desc: 'A full year of selling plus featured placement.',
            pr_popular: 'Popular',
            pr_best_value: 'Best Value',
            pr_choose: 'Choose plan',
            pr_load_failed: 'Could not load plans. Please try again later.',
            pr_how_title: 'How It Works',
            pr_step1: 'Choose a plan and enter your M-Pesa number.',
            pr_step2: 'You get an M-Pesa prompt on your phone — enter your PIN.',
            pr_step3: 'M-Pesa confirms your payment instantly.',
            pr_step4: 'Your subscription activates and you start selling.',
            pr_request_title: 'Request a Subscription',
            pr_request_sub: 'Choose a plan and enter your M-Pesa number. We send an M-Pesa prompt to your phone for the exact amount — approve it and your membership activates instantly.',
            pr_plan_label: 'Plan',
            pr_plan_starter: 'Starter — 800 KES / month',
            pr_plan_grower: 'Grower — 3,000 KES / 6 months',
            pr_plan_pro: 'Pro Farmer — 5,000 KES / 12 months',
            pr_mpesa_phone: 'M-Pesa phone number',
            pr_pay_btn: 'Pay with M-Pesa',
            pr_login_hint: 'You need to be logged in as a farmer to subscribe.',
            pr_expiry_title: 'What happens when a plan expires?',
            pr_expiry_1: 'Your existing listings stay visible, and buyers can still contact you.',
            pr_expiry_2: 'You can no longer post new listings or edit existing ones.',
            pr_expiry_3: 'Renew with the same plan or upgrade — just request a new payment.',
            pr_expiry_4: 'Browsing the marketplace, learning articles and market insights stay free forever.',
            pr_pay_note_title: 'How to pay with M-Pesa',
            pr_pay_note_1: '1. Choose a plan and type in the M-Pesa number you want to pay from.',
            pr_pay_note_2: '2. We send an M-Pesa prompt to that phone for the exact plan amount.',
            pr_pay_note_3: '3. Enter your M-Pesa PIN on your phone to approve the payment.',
            pr_pay_note_4: 'Your subscription activates automatically the moment M-Pesa confirms.',
            pr_otp_title: 'Enter the code from your phone',
            pr_otp_sub: 'Enter the one-time code (OTP) that Paystack sent to your M-Pesa phone to complete this payment. If you did not receive an SMS, open the payment again.',
            pr_otp_placeholder: '123456',
            pr_otp_btn: 'Confirm code',
            pr_otp_sending: 'Confirming...',
            pr_otp_err: 'Could not confirm the code. Please try again.',
            pr_otp_refresh: 'Request a new payment instead',
            tt_loading: 'Loading testimonials...',
            tt_empty: 'No testimonials yet. Be the first to share your experience with KCNP Agro.',
            tt_cta: 'Share your experience',
            d_feedback_title: 'Share your experience',
            d_feedback_sub: 'Let others know what KCNP Agro has done for you. Your testimonial becomes visible after an admin approves it.',
            d_feedback_rating: 'Rating',
            d_feedback_msg: 'Your testimonial',
            d_feedback_submit: 'Submit testimonial',
            d_membership: 'My Membership',
            d_membership_subscribe: 'Subscribe Now',
        ...
        sw: {
            ...
            p_activate: 'Amilisha Akaunti <span class="gradient-text">Yako</span>',
            p_activate_sub: 'Thibitisha barua pepe yako ili kuanza kutumia KCNP Agro.',
            ...
            pr_eyebrow: 'Uanachama wa Mkulima',
            pr_title: 'Mipango Rahisi, ya bei Nafuu',
            pr_sub: 'Uza mazao yako moja kwa moja kwa wafanyabiashara. Bei ziko kwa Shilingi za Kenya na hulipwa kwa M-Pesa — gharama ya kuku mmoja kwa mwezi.',
            pr_per_month: 'mwezi',
            pr_months: 'miezi',
            pr_plan_starter_desc: 'Chapisha mazao yako na ufikie wafanyabiashara kwa mwezi 1.',
            pr_plan_grower_desc: 'Mpango maarufu wa mwanzoni — miezi 6 ya matangazo bila kikomo.',
            pr_plan_pro_desc: 'Mwaka mzima wa mauzo pamoja na nafasi ya kipekee.',
            pr_popular: 'Maarufu',
            pr_best_value: 'Thamani Bora',
            pr_choose: 'Chagua mpango',
            pr_load_failed: 'Haikuweza kupakia mipango. Tafadhali jaribu tena baadaye.',
            pr_how_title: 'Inavyofanya Kazi',
            pr_step1: 'Chagua mpango na uandike nambari yako ya M-Pesa.',
            pr_step2: 'Utapokea arifa ya M-Pesa kwenye simu yako — weka PIN yako.',
            pr_step3: 'M-Pesa inathibitisha malipo yako mara moja.',
            pr_step4: 'Uanachama wako unamilishwa na unaanza kuuza.',
            pr_request_title: 'Omba Uanachama',
            pr_request_sub: 'Chagua mpango na uandike nambari yako ya M-Pesa. Tutatuma arifa ya M-Pesa kwa kiasi kamili — kuidhinisha na uanachama wako unamilishwa mara moja.',
            pr_plan_label: 'Mpango',
            pr_plan_starter: 'Starter — Sh 800 / mwezi',
            pr_plan_grower: 'Grower — Sh 3,000 / miezi 6',
            pr_plan_pro: 'Pro Farmer — Sh 5,000 / miezi 12',
            pr_mpesa_phone: 'Nambari ya M-Pesa',
            pr_pay_btn: 'Lipa kwa M-Pesa',
            pr_login_hint: 'Unahitaji kuingia kama mkulima ili kujiunga.',
            pr_expiry_title: 'Nini kinatokea mpango ukimalizika?',
            pr_expiry_1: 'Matangazo yako yaliyopo yanaendelea kuonekana, na wanunuzi wanaweza kuwasiliana nawe.',
            pr_expiry_2: 'Hutaweza tena kuchapisha matangazo mapya au kuhariri yaliyopo.',
            pr_expiry_3: 'Sasisha kwa mpango ule ule au boresha — omba tu malipo mapya.',
            pr_expiry_4: 'Kuangalia soko, makala za kujifunza na uchambuzi wa soko hubakia bure milele.',
            pr_pay_note_title: 'Jinsi ya Kulipa kwa M-Pesa',
            pr_pay_note_1: '1. Chagua mpango na uandike nambari ya M-Pesa unayotaka kulipa nayo.',
            pr_pay_note_2: '2. Tunatuma arifa ya M-Pesa kwa kiasi kamili cha mpango kwenye nambari hiyo.',
            pr_pay_note_3: '3. Weka PIN yako ya M-Pesa kwenye simu yako kuidhinisha malipo.',
            pr_pay_note_4: 'Uanachama wako unamilishwa kiotomatiki mara M-Pesa inapothibitisha.',
            pr_otp_title: 'Weka nambari uliyopokea kwenye simu',
            pr_otp_sub: 'Weka nambari fupi (OTP) ambayo Paystack imekutumia kwenye simu yako ya M-Pesa kukamilisha malipo. Ukipokea SMS, ingiza nambari hapa.',
            pr_otp_placeholder: '123456',
            pr_otp_btn: 'Thibitisha nambari',
            pr_otp_sending: 'Inathibitisha...',
            pr_otp_err: 'Haikuweza kuthibitisha nambari. Tafadhali jaribu tena.',
            pr_otp_refresh: 'Omba malipo mapya badala yake',
            tt_loading: 'Tunapakia maoni...',
            tt_empty: 'Bado hakuna maoni. Kuwa wa kwanza kushiriki uzoefu wako na KCNP Agro.',
            tt_cta: 'Shiriki uzoefu wako',
            d_feedback_title: 'Shiriki uzoefu wako',
            d_feedback_sub: 'Wajulishe wengine kile KCNP Agro imekufanyia. Maoni yako yanaonekana baada ya msimamizi kuidhinisha.',
            d_feedback_rating: 'Ukadiriaji',
            d_feedback_msg: 'Maoni yako',
            d_feedback_submit: 'Wasilisha maoni',
            ...
            d_membership: 'Uanachama Wangu',
            d_membership_subscribe: 'Jiunge Sasa',
    ...
    var PHRASES =
{
  ...
  "A lowercase letter": "Herufi ndogo",
  "An uppercase letter": "Herufi kubwa",
  "A number": "Nambari",
  "A special character (!@#$%^&*)": "Herufi maalum (!@#$%^&*)",
  "Strength": "Nguvu",
  "Weak": "Dhaifu",
  "Fair": "Wastani",
  "Good": "Nzuri",
  ...
  "Account created. We sent an activation link to your email — click it to activate your account.": "Akaunti imeundwa. Tulikutumia kiungo cha kuamisha barua pepe yako — bofya kukiwezesha.",
  "Account created. Email delivery is unavailable, so your activation link is shown below.": "Akaunti imeundwa. Uwasilishaji wa barua pepe haupatikani, kwa hivyo kiungo chako cha kuamisha kinaonyeshwa hapa chini.",
  "Your account is not activated yet. Please check your inbox for the activation email.": "Akaunti yako bado haijamilishwa. Tafadhali angalia kikasha chako kwa barua pepe ya kuamisha.",
  "This activation link is invalid or has expired. Please request a new one.": "Kiungo hiki cha kuamilisha si sahihi au kimeisha. Tafadhali omba kipya.",
  "Your account has been activated. You can now log in.": "Akaunti yako imeamilishwa. Sasa unaweza kuingia.",
  "If that email is registered and pending activation, a new activation link has been sent.": "Ikiwa barua pepe hiyo imesajiliwa na haijamilishwa, kiungo kipya cha kuamisha kimetumwa.",
  "Failed to activate your account. Please try again.": "Imeshindikana kuamilisha akaunti yako. Tafadhali jaribu tena.",
  "Failed to resend the activation link. Please try again.": "Imeshindikana kutuma upya kiungo cha kuamilisha. Tafadhali jaribu tena.",
  "A new activation link has been generated.": "Kiungo kipya cha kuamilisha kimetengenezwa.",
  "Click here to activate": "Bonyeza hapa kuamilisha",
  "Resend activation email": "Tuma tena barua pepe ya kuamilisha",
  "Activating your account...": "Inamilisha akaunti yako...",
  "Activation link sent successfully": "Kiungo cha kuamilisha kimetumwa kwa mafanikio",
  "An active subscription is required to post listings. Choose a plan and subscribe.": "Uanachama amilifu unahitajika kuchapisha matangazo. Chagua mpango na ujiunge.",
  "Payment request received. You will be contacted to confirm your M-Pesa payment (or approve from the admin dashboard), then your subscription activates.": "Ombi la malipo limepokelewa. Utawasiliana nasi ili kuthibitisha malipo yako ya M-Pesa, kisha uanachama wako unamilishwa.",
  "M-Pesa prompt sent to your phone. Enter your PIN on the M-Pesa screen to complete the payment — your subscription activates automatically.": "Arifa ya M-Pesa imetumwa kwenye simu yako. Weka PIN yako kwenye skrini ya M-Pesa kukamilisha malipo — uanachama wako unamilishwa kiotomatiki.",
  "Unknown subscription plan.": "Mpango huo haujulikani.",
  "Please provide a valid M-Pesa number.": "Tafadhali toa nambari sahihi ya M-Pesa.",
  "Failed to create the payment request.": "Imeshindikana kuunda ombi la malipo.",
  "Failed to fetch your membership.": "Imeshindikana kupata uanachama wako.",
  "Please log in as a farmer first.": "Tafadhali ingia kama mkulima kwanza.",
  "Payment request received.": "Ombi la malipo limepokelewa.",
  "expires": "kuisha",
  "Renew / Upgrade": "Sasisha / Boresha",
  "Pending payment": "Malipo yanasubiriwa",
  "your M-Pesa payment is being processed. Keep an eye on your phone.": "malipo yako ya M-Pesa yanachakatwa. Angalia simu yako.",
  "No active subscription": "Hakuna uanachama amilifu",
  "subscribe to post and sell your produce.": "jiunge ili kuchapisha na kuuza mazao yako.",
  "Subscription status unavailable.": "Hali ya uanachama haipatikani.",
  "Failed to post. A subscription is required.": "Imeshindikana kuchapisha. Uanachama unahitajika.",
  "User not found.": "Mtumiaji hajapatikana.",
  "You cannot demote or deactivate yourself.": "Huwezi kushusha cheo chako au kujizuia mwenyewe.",
  "User updated.": "Mtumiaji amesasishwa.",
  "Failed to update the user.": "Imeshindikana kusasisha mtumiaji.",
  "You cannot delete your own account.": "Huwezi kufuta akaunti yako mwenyewe.",
  "User deleted.": "Mtumiaji amefutwa.",
  "Failed to delete the user.": "Imeshindikana kufuta mtumiaji.",
  "Payment not found.": "Malipo hayajapatikana.",
  "Failed to update the payment.": "Imeshindikana kusasisha malipo.",
  "Listing not found.": "Tangazo halijapatikana.",
  "Listing deleted.": "Tangazo limefutwa.",
  "Failed to load listings.": "Imeshindikana kupakia matangazo.",
  "Failed to load the admin overview.": "Imeshindikana kupakia muhtasari wa msimamizi.",
  "Failed to load users.": "Imeshindikana kupakia watumiaji.",
  "Failed to load payments.": "Imeshindikana kupakia malipo.",
  "Failed to load the audit log.": "Imeshindikana kupakia rekodi ya ukaguzi.",
  "Failed to load subscriptions.": "Imeshindikana kupakia uanachama.",
  "Subscribe now": "Jiunge sasa",
  "Check status": "Angalia hali",
  "Account created! We sent an activation link to your email — click it to activate your account.": "Akaunti imeundwa! Tulikutumia kiungo cha kuamisha barua pepe yako — bofya kukiwezesha.",
  "If that email is registered, a new activation link has been sent.": "Ikiwa barua pepe hiyo imesajiliwa, kiungo kipya cha kuamisha kimetumwa.",
  "Awaiting email confirmation": "Kusubiri uthibitisho wa barua pepe",
  "You do not have permission to perform this action.": "Huna ruhusa ya kufanya kitendo hiki."
}
;
var PHRASE_REV = {};
    (function () {
